...
const regiao = "Europa";// regiao escolhida para a viagem podendo ser: Norte do Brasil, Sul do Brasil, Asia, Europa e Africa
...
let poradulto = ((1800*10)/100)+ adulto * valoradultonorte; // 10% a mais 
let porinfantil = ((2500*20)/100)+ infantil * valorinfantilnorte; // 20% a mais
